...
contract MoonMakerProtocol is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    // Burn address
    address public constant TEAM_ADDRESS =
        0xBEAB7504704a7299A4df8D94731F7F723AD00ae7;
    ...
    string private _name = "MoonMakerProtocol";
    string private _symbol = "MMP";
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "MMP::transfer: Mkt value invalid"
            );
